    ...
    public class Human : IComparable<Human>
    {
        ...
        public override string ToString()
        {
            ...
            if (Gender == Genders.Male)
            {
                ...
                {
                    res += $"Wife - {Partner.FullName} [id={Partner.Identifier}] ";
                }
            }
            else
            {
                ...
                {
                    res += $"Husband - {Partner.FullName} [id={Partner.Identifier}] ";
                }
            }
            res += ", ";
            if (Mother == null)
            ...
            {
                res += $"Mother - {Mother.FullName} [id={Mother.Identifier}]";
            }
            res += ", ";
            if (Father == null)
            {
            ...
            {
                res += $"Father - {Father.FullName} [id={Father.Identifier}]";
            }
            res += "\n";
            if (Children.Count == 0)
            {
